...
export function getSkillToolSchema(skillName: string, toolName: string): Record<string, any> | null {
 ...
 */
export async function executeSkillValidation(skillName: string): Promise<{ valid: boolean; error?: string }> {
 ...
 */
export async function executeSkillScript(skillName: string, scriptName: string, args: Record<string, any>): Promise<{ output: any; error?: string }> {
